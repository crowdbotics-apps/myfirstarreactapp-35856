...
## Project Structure
    ...
    ├── myfirstarreactapp_35856  # Django project configurations
...
1. Clone this repo and `cd myfirstarreactapp_35856`
...
2. Clone this repo and `cd myfirstarreactapp_35856`
